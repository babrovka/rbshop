...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.dom_class = 'plain-menu js-cases-menu'

    Case.all.each do |kase|
      primary.item "case-#{kase.id}", "#{kase.title}<i class='plain-menu__item-icon fa fa-chevron-right'></i>".html_safe, case_path(kase), class: 'plain-menu__item'
    end
