    ...
    window.init_papercrop = function() {
        $("div[id$=_cropbox]").each(function() {
            ...
            update_crop = function(coords) {
                ...
                $crop.closest('.fields').find("#" + attachment + "_crop_x").val(Math.round(coords.x));
                $crop.closest('.fields').find("#" + attachment + "_crop_y").val(Math.round(coords.y));
                $crop.closest('.fields').find("#" + attachment + "_crop_w").val(Math.round(coords.w));
                $crop.closest('.fields').find("#" + attachment + "_crop_h").val(Math.round(coords.h));
            };
